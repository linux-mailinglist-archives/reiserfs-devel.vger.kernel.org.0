...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 647C3190A84
	for <lists+reiserfs-devel@lfdr.de>; Tue, 24 Mar 2020 11:19:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727253AbgCXKTS (ORCPT <rfc822;lists+reiserfs-devel@lfdr.de>);
        Tue, 24 Mar 2020 06:19:18 -0400
Received: from mail7.static.mailgun.info ([104.130.122.7]:17031 "EHLO
        mail7.static.mailgun.info" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726994AbgCXKTS (ORCPT
        <rfc822;reiserfs-devel@vger.kernel.org>);
        Tue, 24 Mar 2020 06:19:18 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mixtli.metztli.it; q=dns/txt;
 s=mx; t=1585045157; h=From: Date: Message-Id: To: Subject: Sender;
 bh=0d+H4vWZvSQqeYkoL6b8zixJ4jTKTvM/nQFHlk+k/IM=; b=vfEXbsbnnt15BxHWf/dq7dVjC9eeus0N1AN7fGYCtemdk0W0c7uCtLGx8OXmvdHpLugqGd+i
 0SxRC//yGquiteLhZ4UBmAIfltXyhZtEsOUL32aGhDyWFR1wXxQi8EjDA7+8UZLnchHDB2aI
 ZwfXraSfVXjRAI6mpKCnUwuMihI=
...
Received: from huitzilopochtli.metztli-it.com (99-130-254-3.lightspeed.sntcca.sbcglobal.net [99.130.254.3])
 by mxa.mailgun.org with ESMTP id 5e79de93.7fb060a4da98-smtp-out-n02;
 Tue, 24 Mar 2020 10:18:59 -0000 (UTC)
Received: by huitzilopochtli.metztli-it.com (Postfix, from userid 1000)
        id 544A557FC91B; Tue, 24 Mar 2020 03:18:56 -0700 (PDT)
Subject: Re: Feedback: segfault on Reiser4 SFRN 5.1.3
To:     <edward.shishkin@gmail.com>, <reiserfs-devel@vger.kernel.org>
X-Mailer: mail (GNU Mailutils 3.5)
Message-Id: <20200324101857.544A557FC91B@huitzilopochtli.metztli-it.com>
Date:   Tue, 24 Mar 2020 03:18:56 -0700 (PDT)
...
On Tue, Mar 24, 2020 at 1:01 AM Metztli Information Technology <jose.r.r@metztli.com> wrote:
>
...
Please, download the installer at the link referenced previously and run it in VirtualBox for the relevant input / output environment. Notwithstanding,
< https://metztli.it/readOnlyEphemeral/unxz-python3.png >
unxz --version
xz (XZ Utils) 5.3.1alpha
liblzma 5.3.1alpha
...
er, previous typo, I meant Python3 3.7.3 / 3.8.2
>
> >
> > Thanks,
> > Edward.
